                    ...
                    <div className="row gutter-24">
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Laptpos</Link></h2>
                                    <span>View more</span>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Laptops accessories</Link></h2>
                                    <span>View more</span>
                                    <div className="link-arrow link-arrow-two">
                                        <Link href="/project-details">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 15" fill="none">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Media accessories</Link></h2>
                                    <span>View more</span>
                                    <div className="link-arrow link-arrow-two">
                                        <Link href="/project-details">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 15" fill="none">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Software</Link></h2>
                                    <span>View more</span>
                                    <div className="link-arrow link-arrow-two">
                                        <Link href="/project-details">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 15" fill="none">
                        ...
                        <div className="col-lg-8">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Sports equipments</Link></h2>
                                    <span>View more</span>
                                    <div className="link-arrow link-arrow-two">
                                        <Link href="/project-details">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 15" fill="none">
