            ...
            <header className="tg-header__style-two" >
                <div className="tg-header__inner-wrap">
                    ...
                    <div className="tg-header__right-side">
                        <div className="tg-header__top tg-header__top-two" style={{padding:"10px 30px"}}>
                            <div className="row">
                                        ...
                                        <nav className="tgmenu__nav">
                                            ...
                                            <div className="tgmenu__action tgmenu__action-two d-none d-md-block">
                                                <ul className="list-wrap">
                                                    ...
                                                    <li className="header-btn"><Link href="/contact" className="btn btn-sm" style={{padding:"10px 20px", fontSize:"10px"}}><i className="far fa-comment-alt" />Get In Touch</Link></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="tgmobile__menu-bottom">
                                                ...
                                                {/* <div className="social-links">
                                                    <ul className="list-wrap">
                                                        ...
                                                        <li><Link target="_blank" href="#"><i className="fab fa-instagram" /></Link></li>
